...
public class MongoDB {
	...
	public static Sesion getSesion(Document documentoSesion) {
		...
		// he modificado esta llamada añadiendo un parámetro false y creado un constructor en la clase Sesion para que lo acepte
		// de esta forma evito la comprobación de la fecha ya que si es anterior a la fecha actual no se podrían ver los datos
		// aunque la información sea antigua, si se intentase hacer una cita con esa sesion no sería posible porque se comprueba
		...
		return new Sesion(getTutoria((Document) documentoSesion.get(TUTORIA)),
				...
				Integer.valueOf(documentoSesion.getString(DURACION)),false);
	}
